<template>
  ...
  <p>Because of the <code>style-loader</code> is not support local export, details in <a target="_blank" href="https://github.com/webpack/style-loader/pull/159">here</a>, so we need this workaround for your SSR app:</p>
  <ol>
    <li>
      use
